...
” вас будет список рациональных чисел в виде
...
or
[ (numer_1, denom_1) , ... (numer_n, denom_n) ]
где все числа €вл€ютс€ положительными целыми числами. ¬ам необходимо получить результат в виде:
...
or
"(N_1, D) ... (N_n, D)"
в зависимости от €зыка (см. примеры тестов), в котором D минимально возможно и
